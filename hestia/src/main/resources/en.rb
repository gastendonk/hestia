...
alertsFor=Alert rules for environment
Edit=Edit
Delete=Delete
Alerts=Alerts
...
AddMTDefinition=Create definition
...
EditMTDefinition=Edit definition
...
AlertsForOracle=Create alert rules for all Oracle DB
istDown=is down
